#Tienda de ropa
"""Geier Indumentaria.
Es un programa que prepara una orden de compra. Primeramente nos presenta un menú con las opciones “Comprar”, “Consultar stock” y “Forma de pago y descuentos”. Seleccionando “2”  muestra la lista de artículos con sus respectivos precios. Para darle al cliente la opción de comprar si lo desea o “salir”. Se b  leccionando “3” nos da información de las alternativas de pago. El precio del flete, recargos si abona con tarjeta o descuento si abona en efectivo. Y seleccionando “1” nos lleva a la compra. Nos muestra la lista de artículos con los precios. Luego tenemos que indicar la cantidad de tipo de artículos que vamos a comprar y de acuerdo a esto el programa solicita el código del artículo y la cantidad que queremos del mismo. Una vez especificado todos los artículos  nos pregunta sobre el modo de pago “tarjeta/efectivo”. Al indicar un método el programa calcula la recarga o el descuento correspondiente y si suma el flete.
